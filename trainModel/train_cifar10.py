...
from model.cifar10.vgg import *
from model.cifar10.resnet import *
from model.cifar10.convNet import *
...
def generate_dataloader():
    ...
    train_loader, test_loader = loadTrainData(
        'cifar10', 128, 1000, transform_train, transform_test)
...
def main():
    ...
    if args.resume:
        ...
        checkpoint = torch.load('../model_weight/lenet_cifar.h5')
    ...
    for epoch in range(start_epoch, start_epoch+200):
        ...
        if acc > best_acc:
            ...
            torch.save(state, '../model_weight/lenet_cifar.h5')
            best_acc = acc
